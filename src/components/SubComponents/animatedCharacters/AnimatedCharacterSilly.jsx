...
const AnimatedCharacterSilly = (props) => {
  const group = useRef()
  const { nodes, materials, animations } = useGLTF('/animatedCharacters/animatedCharacterSilly.glb')
  ...
  return (
    <group ref={group} {...props} dispose={null}>
      <group name="Scene">
        <group name="Armature" scale={60} position={[0, -3, 0]}>
...
export default AnimatedCharacterSilly
